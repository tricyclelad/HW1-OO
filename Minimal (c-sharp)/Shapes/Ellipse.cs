...
namespace Shapes
{
    public class Ellipse
    {
        ...
        //public Ellipse(double _x1, double _y1,double _x2,double _y2,double _x3,double _y3,double _x4, double _y4)
        //{
        //    Point _Vertex1 = new Point(_x1, _y1);
        //    Point _Vertex2 = new Point(_x1, _y1);
        //    Point _Vertex3 = new Point(_x1, _y1);
        //    Point _Vertex4 = new Point(_x1, _y1);
